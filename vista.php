<?php
	...
	class Vista {
		...
		public function dibujar($modelo, $e){
			...
			imagestring($img, 3, ($modelo->punto1->x+round($e->X,2))/2, ($modelo->punto1->y+round($e->Y,2))/2, "L3=" . round($modelo->lado3,2), $negro);
            imagestring($img, 4, 10, 10, "P ALTURA = (". round($e->X,2) .", ". round($e->Y,2) .")", $negro);
